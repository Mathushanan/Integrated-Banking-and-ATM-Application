 ...
 * @author Mathu
 */
public class CreateCurrentAccount extends javax.swing.JFrame {

    /**
     * Creates new form CreateCurrentAccount
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateCurrentAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateCurrentAccount().setVisible(true);
            }
        });
    }
