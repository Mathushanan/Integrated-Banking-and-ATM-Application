 ...
 * @author Mathu
 */
public class CreateSalaryAccount extends javax.swing.JFrame {

    /**
     * Creates new form CreateSalaryAccount
     */
    public CreateSalaryAccount() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateSalaryAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateSalaryAccount().setVisible(true);
            }
        });
    }
