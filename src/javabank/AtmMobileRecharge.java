...
public class AtmMobileRecharge extends javax.swing.JFrame {

    private String mail;
    private String connectionType;

    public AtmMobileRecharge(String mail) {
        initComponents();
        this.mail = mail;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtmMobileRecharge.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtmMobileRecharge("").setVisible(true);
            }
        });
    }
