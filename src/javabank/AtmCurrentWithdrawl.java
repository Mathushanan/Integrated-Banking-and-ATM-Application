...
public class AtmCurrentWithdrawl extends javax.swing.JFrame {
  ...
  private String mail;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 140, 370, 310));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtmCurrentWithdrawl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtmCurrentWithdrawl("").setVisible(true);
            }
        });
    }
