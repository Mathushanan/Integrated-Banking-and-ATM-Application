 ...
 * @author Mathu
 */
public class CreateFixedAccount extends javax.swing.JFrame {

    /**
     * Creates new form CreateFixedAccount
     */
    public CreateFixedAccount() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateFixedAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateFixedAccount().setVisible(true);
            }
        });
    }
