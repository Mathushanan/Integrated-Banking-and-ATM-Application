...
public class AtmPin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        atmPin.setFont(new java.awt.Font("Segoe UI", 0, 48)); // NOI18N
        atmPin.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(224, 224, 224)));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(atmPin, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(28, 28, 28)
                .addComponent(atmPin, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void submitBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submitBtnMouseClicked
        ...
        if (atmPin.getText().trim().isEmpty()) {
            MessageBox messageBox = new MessageBox();
            messageBox.getMessageBoxWar(this, "Enter your PIN!");
        } else if (atmPin.getText().trim().length() < 4 || atmPin.getText().trim().length() > 4) {
            MessageBox messageBox = new MessageBox();
            messageBox.getMessageBoxWar(this, "Invalid PIN!");
        } else if(obj1.isValidPin(Integer.parseInt(atmPin.getText().trim()))){
            this.dispose();
