...
public class AtmTransferFunds extends javax.swing.JFrame {

    private String mail;
    private int AccNo;
    private double Amount;
    
    public AtmTransferFunds(String mail) {
        initComponents();
        this.mail=mail;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtmTransferFunds.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtmTransferFunds("").setVisible(true);
            }
        });
    }
